...
namespace Dal
{
    ...
    {
        System.Data.Entity.DbSet<Answare> Answares { get; set; } // Answares
    ...
    {
        public System.Data.Entity.DbSet<Answare> Answares { get; set; } // Answares
        ...
        protected override void OnModelCreating(System.Data.Entity.DbModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Configurations.Add(new AnswareConfiguration());
        ...
        {
            modelBuilder.Configurations.Add(new AnswareConfiguration(schema));
    ...
    {
        public System.Data.Entity.DbSet<Answare> Answares { get; set; }
        ...
        {
            Answares = new FakeDbSet<Answare>("Id");
    ...
    public class Answare
    {
        ...
        // Reverse navigation
        public virtual System.Collections.Generic.ICollection<Task> Tasks { get; set; } // Tasks.FK__Tasks__AnswareId__164452B1
    ...
    public class Document
    {
        ...
        // Reverse navigation
        public virtual System.Collections.Generic.ICollection<Document> Documents { get; set; } // Documents.FK__Documents__Princ__0BC6C43E
        public virtual System.Collections.Generic.ICollection<Task> Tasks { get; set; } // Tasks.FK__Flows__Principal__0DAF0CB0

        // Foreign keys
        public virtual Document PrincipalDocument { get; set; } // FK__Documents__Princ__0BC6C43E
        public virtual Person Person { get; set; } // FK__Documents__Perso__0AD2A005
    ...
    public class FlowType
    {
        ...
        public virtual System.Collections.Generic.ICollection<Task> Tasks { get; set; } // Tasks.FK__Flows__FlowTypeI__0CBAE877
    ...
    public class FlowTypesContributor
    {
        ...
        // Foreign keys
        public virtual FlowType FlowType { get; set; } // FK__FlowTypes_Co__Id__0EA330E9
        public virtual Person Person { get; set; } // FK__FlowTypes__Perso__0F975522
    }
    ...
    public class Person
    {
        ...
        // Reverse navigation
        public virtual System.Collections.Generic.ICollection<Document> Documents { get; set; } // Documents.FK__Documents__Perso__0AD2A005
        public virtual System.Collections.Generic.ICollection<FlowTypesContributor> FlowTypesContributors { get; set; } // Many to many mapping
        public virtual User User { get; set; } // Users.FK__Users__Id__1AD3FDA4

        // Foreign keys
        public virtual Role Role { get; set; } // FK__Persons__RoleId__108B795B
    ...
    public class Role
    {
        ...
        // Reverse navigation
        public virtual System.Collections.Generic.ICollection<Person> People { get; set; } // Persons.FK__Persons__RoleId__108B795B
    ...
    public class Task
    {
        ...
        // Foreign keys
        public virtual Answare Answare { get; set; } // FK__Tasks__AnswareId__164452B1
        public virtual Document Document { get; set; } // FK__Flows__Principal__0DAF0CB0
        public virtual FlowType FlowType { get; set; } // FK__Flows__FlowTypeI__0CBAE877
    }
    ...
    // Answares
    [System.CodeDom.Compiler.GeneratedCode("EF.Reverse.POCO.Generator", "2.24.0.0")]
    public class AnswareConfiguration : System.Data.Entity.ModelConfiguration.EntityTypeConfiguration<Answare>
    {
        public AnswareConfiguration()
            : this("dbo")
        {
        }

        public AnswareConfiguration(string schema)
        {
            ToTable("Answares", schema);
            HasKey(x => x.Id);
    ...
    public class DocumentConfiguration : System.Data.Entity.ModelConfiguration.EntityTypeConfiguration<Document>
    {
        ...
        public DocumentConfiguration(string schema)
        {
            ...
            // Foreign keys
            HasOptional(a => a.PrincipalDocument).WithMany(b => b.Documents).HasForeignKey(c => c.PrincipalDocumentId).WillCascadeOnDelete(false); // FK__Documents__Princ__0BC6C43E
            HasRequired(a => a.Person).WithMany(b => b.Documents).HasForeignKey(c => c.PersonId).WillCascadeOnDelete(false); // FK__Documents__Perso__0AD2A005
        }
    }
    ...
    public class FlowTypesContributorConfiguration : System.Data.Entity.ModelConfiguration.EntityTypeConfiguration<FlowTypesContributor>
    {
        ...
        public FlowTypesContributorConfiguration(string schema)
        {
            ...
            // Foreign keys
            HasRequired(a => a.FlowType).WithMany(b => b.FlowTypesContributors).HasForeignKey(c => c.Id).WillCascadeOnDelete(false); // FK__FlowTypes_Co__Id__0EA330E9
            HasRequired(a => a.Person).WithMany(b => b.FlowTypesContributors).HasForeignKey(c => c.PersonId).WillCascadeOnDelete(false); // FK__FlowTypes__Perso__0F975522
        }
    }
    ...
    public class PersonConfiguration : System.Data.Entity.ModelConfiguration.EntityTypeConfiguration<Person>
    {
        ...
        public PersonConfiguration(string schema)
        {
            ...
            // Foreign keys
            HasRequired(a => a.Role).WithMany(b => b.People).HasForeignKey(c => c.RoleId).WillCascadeOnDelete(false); // FK__Persons__RoleId__108B795B
        }
    }
    ...
    // Tasks
    [System.CodeDom.Compiler.GeneratedCode("EF.Reverse.POCO.Generator", "2.24.0.0")]
    public class TaskConfiguration : System.Data.Entity.ModelConfiguration.EntityTypeConfiguration<Task>
    {
        ...
        public TaskConfiguration(string schema)
        {
            ...
            // Foreign keys
            HasOptional(a => a.Answare).WithMany(b => b.Tasks).HasForeignKey(c => c.AnswareId).WillCascadeOnDelete(false); // FK__Tasks__AnswareId__164452B1
            HasRequired(a => a.Document).WithMany(b => b.Tasks).HasForeignKey(c => c.PrincipalDocumentId).WillCascadeOnDelete(false); // FK__Flows__Principal__0DAF0CB0
            HasRequired(a => a.FlowType).WithMany(b => b.Tasks).HasForeignKey(c => c.FlowTypeId).WillCascadeOnDelete(false); // FK__Flows__FlowTypeI__0CBAE877
        }
    }
